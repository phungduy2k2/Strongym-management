...
export async function GET() {
  try {
    await connectToDB();
    const allMembers = await Member.find({}).populate("membershipPlanId");
...
//           res
//             .status(204)
//             .json({ success: true, message: messages.getAllMember.NO_FOUND });
//         }
//       } catch (err) {
//         console.log(err);
//         // return NextResponse.json({
...
//         res
//           .status(500)
//           .json({ success: false, message: messages.getAllMember.ERROR });
//       }
//       break;
...
//       res
//         .status(405)
//         .json({ success: false, message: "Method not allowed hehe" });
//       break;
//   }
